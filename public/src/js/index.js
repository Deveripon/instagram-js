...
createPostForm.addEventListener("submit", function (e) {
  ...
  if (!objectData.content && !objectData.photo) {
    ...
    // Function to update the post timestamp with "time ago"
    ...
    const dataArray = {
      ...
      userphoto: objectData.userphoto?objectData.userphoto:'';
    };
        ...
        <div class="footer-content">
          ...
          <div class="post-comments">
            ...
            <div class="comment-form">
              ...
              <input class="submit-${index}" id="submit" type="submit" value="Post">
            </div>
            <div id="divider"></div>
          </div>
        </div>
